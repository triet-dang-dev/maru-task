...
- Current UI domains keep specialized adapters under `app/api/auth`, `app/api/v1/projects`, `app/api/v1/users`, and `app/api/v1/work-items` so external `.NET` envelopes are validated and mapped to stable browser view models.
